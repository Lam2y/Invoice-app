...
const onEdit = (id) => {
    if(form.value.invoice_items.length>=1){
        ...
        formData.append('customer_id', form.value.customer_id); // Ensure customer_id is integer
        formData.append('date', form.value.date);
        formData.append('due_date', form.value.due_date);
        formData.append('number', form.value.number);
        formData.append('reference', form.value.reference);
        formData.append('discount', form.value.Discount); // Ensure discount is numeric
        formData.append('subtotal', subtotal); // Ensure subTotal is numeric
        formData.append('total', total); // Ensure total is numeric
                ...
                <div class="card__content--header">
                    <div>
                        ...
                        <select name="" id="" class="input" v-model="form.customer_id">
                            ...
                            <option v-for="customer in allcustomers" :value="customer.id">{{ customer.firstname }}
                            </option>
                        </select>
                    </div>
                    <div>
